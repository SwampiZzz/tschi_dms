  ...
  <body>
    ...
    <section class="hero-section d-flex align-items-center justify-content-center">
      <div class="text-center">
        ...
        <div class="mt-3">
          <a class="btn login-btn btn-outline-light me-2" data-bs-toggle="modal" data-bs-target="#login-pop-up">Login now</a>
          <a class="btn sign-up-btn" data-bs-toggle="modal" data-bs-target="#sign-up-pop-up">Sign up now</a>
        </div>
      </div>
    </section>
    <?php
